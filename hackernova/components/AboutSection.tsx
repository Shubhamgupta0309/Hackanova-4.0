  ...
  return (
    <section id="about" className="py-20 px-4">
      <div className="container mx-auto">
        ...
        >
          Hackernova 4.0 is a dynamic journey that brings together talented students, mentors, 
          and institutions to solve real-world problems through code. 
          It's a space where passion meets technology, and every line of code has the power to change the world. <br />
