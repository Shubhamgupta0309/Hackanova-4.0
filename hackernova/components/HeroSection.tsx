      ...
      <div className="flex justify-center space-x-4 md:space-x-8">
        {timerActive
          ? timerComponents.length
            ? timerComponents
            : <span className="text-2xl text-yellow-400">Loading...</span>
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden">
      ...
      <motion.div 
        className="relative z-10 text-center px-4 py-8 rounded-lg w-full max-w-4xl"
        style={{ y, opacity }}
      >
        <motion.h1
        ...
        >
          <CountdownTimer targetDate={new Date('2025-02-14T00:00:00')} label="Event Starts In:" />
          <CountdownTimer targetDate={new Date('2025-02-01T00:00:00')} label="Registration Closes In:" />
        </motion.div>
      </motion.div>
    </section>
  )
